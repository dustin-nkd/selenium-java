...
public class RegisterTestCase {
    ...
    public void Register_02_Invalid_Email() {
        ...
        driver.findElement(By.id("txtFirstname")).sendKeys("Donald Trump");
    ...
    public void Register_03_Incorrect_Confirm_Email() {
        ...
        driver.findElement(By.id("txtFirstname")).sendKeys("Donald Trump");
        driver.findElement(By.id("txtEmail")).sendKeys("donaldtrump@gmail.vn");
        driver.findElement(By.id("txtCEmail")).sendKeys("donaldtrump@gmail.net");
        driver.findElement(By.id("txtPassword")).sendKeys("123456");
        driver.findElement(By.id("txtCPassword")).sendKeys("123456");
        driver.findElement(By.id("txtPhone")).sendKeys("0987654321");
    ...
    public void Register_04_Invalid_Password() {
        ...
        driver.findElement(By.id("txtFirstname")).sendKeys("Donald Trump");
        driver.findElement(By.id("txtEmail")).sendKeys("donaldtrump@gmail.vn");
        driver.findElement(By.id("txtCEmail")).sendKeys("donaldtrump@gmail.vn");
    ...
    public void Register_05_Incorrect_Confirm_Password() {
        ...
        driver.findElement(By.id("txtCEmail")).sendKeys("donaldtrump@gmail.vn");
        driver.findElement(By.id("txtPassword")).sendKeys("123456");
        driver.findElement(By.id("txtCPassword")).sendKeys("123454");
        driver.findElement(By.id("txtPhone")).sendKeys("0987654321");
    ...
    public void Register_06_Invalid_Phone_Number() {
        ...
        driver.findElement(By.id("txtPassword")).sendKeys("123456");
        driver.findElement(By.id("txtCPassword")).sendKeys("123456");
        driver.findElement(By.id("txtPhone")).sendKeys("098755555555");
        ...
        driver.findElement(By.id("txtPhone")).sendKeys("09875555555E");
        Assert.assertEquals(driver.findElement(By.id("txtPhone-error")).getText(),"Vui lòng nhập con số");

        driver.findElement(By.id("txtPhone")).clear();
        driver.findElement(By.id("txtPhone")).sendKeys("987645421");
